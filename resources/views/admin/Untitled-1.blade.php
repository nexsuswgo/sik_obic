                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{asset('assets/img/WhatsApp Image 2023-08-03 at 14.54.03.png')}}" width="50px">
                                        </div>
                                        <div class="col-md-auto">
                                            <h5 class="text-center font-weight my-4">Sistem Informasi Keuangan OBIC Ketapang</h5>
                                        </div>
                                    </div>
