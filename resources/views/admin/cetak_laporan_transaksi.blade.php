        ...
        <article>
            ...
            <table class="meta">
                ...
                <tr>
                    ...
                    <td><span>Transaksi Data</span></td>
                </tr>
                                <tr>
                ...
                <tbody>
                    @foreach ($transaksi as $item)
                        <tr>
                            ...
                            <td>{{ $item->jenis }}</td>
                            <td><span data-prefix>Rp </span><span>{{ $item->nominal }}</span></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="balance">
                <tr>
                    <th><span>Pemasukan Total</span></th>
                    <td><span data-prefix>Rp </span><span>{{$pemasukan}}</span></td>
                </tr>
                <tr>
                    <th><span>Pengeluaran Total</span></th>
                    <td><span data-prefix>Rp </span><span>{{$pengeluaran}}</span></td>
                </tr>
                <tr>
                    <th><span>Saldo Total</span></th>
                    <td><span data-prefix>Rp </span><span>{{$saldo}}</span></td>
                </tr>
            </table>
        </article>
        <aside>
